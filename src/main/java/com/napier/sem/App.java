...
public class App {
    ...
    public Employee getEmployee(int ID) {
        try {
            ...
            String strSelect =
                    "SELECT e.emp_no, e.first_name, e.last_name, s.salary, t.title, d.dept_name, dm.emp_no AS manager_emp_no, m.first_name AS manager_first_name, m.last_name AS manager_last_name " +
                            "FROM employees e " +
    ...
    public Employee getSalaryByRole() {
        try {
            Statement stmt = con.createStatement();
            String strSelect =
    ...
    public static void main(String[] args)
    {
        ...
        // Connect to database
        if(args.length < 1){
            a.connect("localhost:33060", 60000);
        }else{
